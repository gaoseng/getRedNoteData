...
class Data_Spider():
    ...
    def spider_some_search_note(self, query: str, require_num: int, cookies_str: str, base_path: dict, save_choice: str, sort = "popularity_descending", note_type=0,  excel_name: str = '', proxies=None):
        """
